...
sed -i -e '/^\s*kernel\s*\/boot\/vmlinuz-.*$/ s/$/ console=ttyS0 earlyprintk=ttyS0 rootdelay=300/' /boot/grub/menu.lst # Append 'console=ttyS0 earlyprintk=ttyS0 rootdelay=300' to kernel
update-grub
